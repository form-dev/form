...
\noindent See also startfloat (\ref{prestartfloat}) and chapter~\ref{floatingpoint} on the floating point capacity.
...
\noindent See also endfloat (\ref{preendfloat}) and chapter~\ref{floatingpoint} on the floating point capacity.
